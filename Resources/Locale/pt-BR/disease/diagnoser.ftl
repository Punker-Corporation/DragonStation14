...
diagnoser-disease-report-name = Nome da doença: {CAPITALIZE($disease)}
diagnoser-disease-report-infectious = Infeccioso: [color=red]Sim[/color]
diagnoser-disease-report-not-infectious = Infeccioso: [color=green]Não[/color]
diagnoser-disease-report-cureresist-none = Resistência para Spaceacillin: [color=green]Nenhuma[/color]
