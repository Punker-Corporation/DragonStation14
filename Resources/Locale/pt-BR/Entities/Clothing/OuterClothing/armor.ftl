...
ent-ClothingOuterArmorHeavyGreen = colete militar verde
    .desc = Um colete altamente resistente com traços em verde. Capaz de proteger o usuário de danos excessívos.

ent-ClothingOuterArmorHeavyRed = colete militar vermelho
    .desc = Um colete altamente resistente com traços em vermelho. Capaz de proteger o usuário de danos excessívos.
