...
ent-ClothingOuterHardsuitEngineering = hardsuit de engenharia
...
ent-ClothingOuterHardsuitRd = hardsuit experimental de pesquisador
...
ent-ClothingOuterHardsuitSalvage = hardsuit de exploração
...
ent-ClothingOuterHardsuitWizard = hardsuit de arcana
    .desc = Um traje bizarro moldado em jóias que radiam energias mágicas.

ent-ClothingOuterHardsuitLing = hardsuit bio-orgânica espacial
...
ent-ClothingOuterHardsuitERTEngineer = hardsuit de engenheiro da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.

ent-ClothingOuterHardsuitERTMedical = hardsuit de paramédico da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.

ent-ClothingOuterHardsuitERTSecurity = hardsuit de segurança da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.
