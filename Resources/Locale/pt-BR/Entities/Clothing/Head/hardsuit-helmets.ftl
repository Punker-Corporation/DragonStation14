...
ent-ClothingHeadHelmetHardsuitSpatio = capacete de espaçonauta
    .desc = Um capacete exageradamente exagerado, planejado especialmente para operações indústriais no espaço.

ent-ClothingHeadHelmetHardsuitCybersun = capacete Ultra-Blindado Cybersun
...
ent-ClothingHeadHelmetHardsuitERTEngineer = capacete de engenheiro da ERT
    .desc = Um capacete especialmente planejado para unidades da ERT.

ent-ClothingHeadHelmetHardsuitERTMedical = capacete de médico da ERT
    .desc = Um capacete especialmente planejado para unidades da ERT.

ent-ClothingHeadHelmetHardsuitERTSecurity = capacete de segurança da ERT
    .desc = Um capacete especialmente planejado para unidades da ERT.

ent-ClothingHeadHelmetHardsuitERTJanitor = capacete de zelador da ERT
    .desc = Um capacete especialmente planejado para unidades da ERT.
