...
ent-FoodPieAppleSlice = fatia de torta de maçã
    .desc = Uma fatia de torta contendo doce, doce amor... ou maçã.
...
ent-FoodPieClafoutisSlice = fatia de clafoutis de frutas vermelhas
    .desc = Não há pássaros pretos nessa fatia, o que é um bom sinal.
...
ent-FoodPieCherrySlice = fatia de torta de cereja
    .desc = O sabor dessa fatia é tão bom, que faz um homem adulto chorar.
...
ent-FoodPieMeatSlice = fatia de torta de carne
    .desc = Uma antiga receita de barbeiros, uma delícia de fatia!

ent-FoodPieXeno = torta de xeno
    .desc = Uma antiga receita de barbeiros, uma delícia... Tem algo de esquisito com essa.

ent-FoodPieXenoSlice = fatia de torta de xeno
    .desc = Uma antiga receita de barbeiros, uma delícia... Tem algo de esquisito com essa fatia.

ent-FoodPieFrosty = torta glacial
    .desc = Tem gosto de azul e frio.

ent-FoodPieFrostySlice = fatia de torta glacial
    .desc = Essa fatia tem gosto de azul e frio.
